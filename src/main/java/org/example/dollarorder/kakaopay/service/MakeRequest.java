...
public class MakeRequest {
    ...
    public PayRequestDto getReadyRequest(PayInfoDto payInfoDto,Long orderId){
        ...
        map.add("approval_url", "http://localhost:8084/payment/success"+"/"+orderId); // 성공 시 redirect url
        map.add("cancel_url", "http://localhost:8084/payment/cancel"); // 취소 시 redirect url
        map.add("fail_url", "http://localhost:8084/payment/fail"); // 실패 시 redirect url
