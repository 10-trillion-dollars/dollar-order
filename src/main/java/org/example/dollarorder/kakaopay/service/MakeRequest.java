...
public class MakeRequest {
    ...
    public PayRequestDto getReadyRequest(PayInfoDto payInfoDto,Long orderId){
        ...
        map.add("approval_url", "https://order.10-trillion-dollars.shop/payment/success"+"/"+orderId); // 성공 시 redirect url
        map.add("cancel_url", "https://order.10-trillion-dollars.shop/payment/cancel"); // 취소 시 redirect url
        map.add("fail_url", "https://order.10-trillion-dollars.shop/payment/fail"); // 실패 시 redirect url
